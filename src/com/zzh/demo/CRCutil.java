...
public class CRCutil {
    ...
    public static void main(String[] args) {
        byte[] bytes = {0x00, 0x00, 0x00, 0x02, 0x55, 0x03, 0x14, 0x12, 0x78, 0x23, 0x05, 0x00};
        String crc3 = getCRC3(bytes);
        byte[] bytes1 = hexStringToBytes(crc3);
        short aShort = byteArrayToShort(bytes1);
        System.out.println("CRCutil.main");
    }
